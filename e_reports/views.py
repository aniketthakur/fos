...
def get_application_headers():
    ...
    headers.append("applicant kyc type")
    headers.append("applicant kyc number")
    headers.append("applicant kyc age")
    headers.append("applicant kyc dob")
    headers.append("applicant kyc name")
    headers.append("applicant kyc taluk")
    headers.append("applicant kyc state")
    headers.append("applicant kyc pincode")
    headers.append("applicant kyc address")
    headers.append("applicant kyc country")
    headers.append("applicant kyc district")
    headers.append("applicant kyc phone number")
    headers.append("applicant kyc mobile number")
    headers.append("applicant kyc father or husband name")

    headers.append("guarantor1 kyc type")
    headers.append("guarantor1 kyc number")
    headers.append("guarantor1 kyc age")
    headers.append("guarantor1 kyc dob")
    headers.append("guarantor1 kyc name")
    headers.append("guarantor1 kyc taluk")
    headers.append("guarantor1 kyc state")
    headers.append("guarantor1 kyc pincode")
    headers.append("guarantor1 kyc address")
    headers.append("guarantor1 kyc country")
    headers.append("guarantor1 kyc district")
    headers.append("guarantor1 kyc phone number")
    headers.append("guarantor1 kyc mobile number")
    headers.append("guarantor1 kyc father or husband name")

    headers.append("guarantor2 kyc type")
    headers.append("guarantor2 kyc number")
    headers.append("guarantor2 kyc age")
    headers.append("guarantor2 kyc dob")
    headers.append("guarantor2 kyc name")
    headers.append("guarantor2 kyc taluk")
    headers.append("guarantor2 kyc state")
    headers.append("guarantor2 kyc pincode")
    headers.append("guarantor2 kyc address")
    headers.append("guarantor2 kyc country")
    headers.append("guarantor2 kyc district")
    headers.append("guarantor2 kyc phone number")
    headers.append("guarantor2 kyc mobile number")
    headers.append("guarantor2 kyc father or husband name")
...
def get_application_rowdata(app):
    ...
    row_data.append(app.applicant_kyc.kyc_type)
    ...
    row_data.append(app.guarantor1_kyc.kyc_type)
    ...
    row_data.append(app.guarantor2_kyc.kyc_type)
