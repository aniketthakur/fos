...
class EsthenosOrgApplication(db.Document):
    ...
    telephone_number = db.StringField(max_length=40, required=False,default="")
    mobile_number = db.StringField(max_length=40, required=False,default="")
    ...
    radio_member_disability=db.StringField(max_length=40, required=False,default="")
