...
class EsthenosOrg(db.Document):
    ...
    postal_telephone = db.StringField(max_length=40, required=False)
    postal_tele_code = db.StringField(max_length=40, required=False)
...
class EsthenosOrgApplicationKYC(db.EmbeddedDocument):
    kyc_number = db.StringField(max_length=40, required=False,default="")
    dob = db.StringField(max_length=40, required=False,default="")
    ...
    gender = db.StringField(max_length=40, required=False,default="")
    ...
    pincode = db.StringField(max_length=40, required=False,default="")
    date_created = db.DateTimeField(default=datetime.datetime.now)
    raw = db.StringField(max_length=4048, required=False)
    validation = db.StringField(max_length=40, required=True,default="PENDING")
...
class EsthenosOrgApplication(db.Document):
    ...
    upload_type = db.StringField(max_length=40, required=False,default="")
    ...
    member_relationship_status = db.StringField(max_length=40, required=False,default="")
    applied_loan  = db.FloatField(default=0.0)
    religion = db.StringField(max_length=40, required=False,default="")
    category = db.StringField(max_length=40, required=False,default="")
    caste = db.StringField(max_length=40, required=False,default="")
    ...
    primary_business = db.StringField(max_length=40, required=False,default="")
    secondary_business_category = db.StringField(max_length=40, required=False,default="")
    secondary_business = db.StringField(max_length=40, required=False,default="")
    tertiary_business_category = db.StringField(max_length=40, required=False,default="")
    tertiary_business = db.StringField(max_length=40, required=False,default="")
    ...
    branch_name = db.StringField(max_length=40, required=False,default="")
    branch_id = db.StringField(max_length=40, required=False,default="")
    state_name = db.StringField(max_length=40, required=False,default="")
    state_id = db.StringField(max_length=40, required=False,default="")
    region_name = db.StringField(max_length=40, required=False,default="")
    region_id  = db.StringField(max_length=40, required=False,default="")
    cm_id  = db.StringField(max_length=40, required=False,default="")
    cm_cell_no  = db.StringField(max_length=40, required=False,default="")
    repeat_application_id   = db.StringField(max_length=40, required=False,default="")
    repayment_method  = db.StringField(max_length=40, required=False,default="")
    ...
    interested_in_other_fp=db.StringField(max_length=40, required=False,default="")
    member_disability=db.StringField(max_length=40, required=False,default="")
    village_water=db.StringField(max_length=40, required=False,default="")
    ...
    village_medical_facilities=db.StringField(max_length=40, required=False,default="")
    micropension_inclusion=db.StringField(max_length=40, required=False,default="")
    self_owned_land=db.StringField(max_length=40, required=False,default="")
    center_leader_cell=db.StringField(max_length=40, required=False,default="")
    center_size=db.IntField(default=0)
    applicationtype=db.StringField(max_length=40, required=False,default="")
    shared_land=db.StringField(max_length=40, required=False,default="")
    bankaccount_inclusion=db.StringField(max_length=40, required=False,default="")
    fl_loans=db.IntField(default=0)
    village_hospital_category=db.StringField(max_length=40, required=False,default="")
    group_leader_cell=db.StringField(max_length=40, required=False,default="")
    bankfi_amount=db.IntField(default=0)
    patta_land=db.StringField(max_length=40, required=False,default="")
    group_size=db.IntField(default=0)
    select_house_type=db.StringField(max_length=40, required=False,default="")
    village_road=db.StringField(max_length=40, required=False,default="")
    fnf_inclusion=db.IntField(default=0)
    member_f_or_h_name=db.StringField(max_length=40, required=False,default="")
    member_pincode=db.StringField(max_length=10, required=False,default="")
    repayment_mode=db.StringField(max_length=40, required=False,default="")
...
class EsthenosOrgApplicationHighMarkRequest(db.Document):
    ...
    phone=db.StringField(max_length=40, required=True,default="")
...
class EsthenosOrgApplicationEqifax(db.Document):
    application_id = db.StringField(max_length=255, required=True,default="")
    reference_number=db.IntField(default=0, required=False)
    member_id_unique_accountnumber=db.IntField(default=0, required=False)
    inquiry_purpose=db.StringField(max_length=255, required=False,default="")
    transaction_amount=db.IntField(default=0, required=False)
