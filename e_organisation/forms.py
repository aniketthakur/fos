...
class AddApplicationMobile(Form):
    ...
    def save(self,app):
        ...
        # app.nominee_relation = data.get("nominee_relation", "")
            ...
            app.total_annual_revenue_crdit = toInt(data.get("total_monthly_revenue__credit", ""))
            ...
            app.total_annual_revenue_csh = toInt(data.get("total_monthly_revenue__cash", ""))
            ...
            app.total_annual_prchase_cash = toInt(data.get("total_monthly_purchase__cash", ""))
            app.raw_material_purchase_in_11_month = data.get("raw_material_purchase_in_11_month", "")
            app.total_annual_prchase_credit = toInt(data.get("total_monthly_purchase__credit", ""))
