...
hmrequest.applicant_id1("GJ/19/137/370571")
...
application = EsthenosOrgApplication()
application.aadhaar_card("565061987998")
application.address("Hal")
application.age("40")
application.applicant_name("Loan")
application.application_id("45D")
application.attendence_percentage("40")
application.business_expense("456789")
application.center("Hal")
application.current_status("")
application.date_created("12/1/2014")
application.date_updated("12/1/2014")
application.defaults_with_no_mfis("")
application.dob("12/1/2045")
application.educational_expense("20000")
application.eligible_loan_cycle("1")
application.entertainment_expense("200")
application.existing_loan_cycle("2")
application.food_expense("20")
application.gender("F")
application.group("")
application.loan_eligibility_based_on_company_policy("")
application.loan_eligibility_based_on_net_income("")
application.medical_expense("100")
application.net_income("1000")
application.organisation("sarmik")
application.other_expense("100")
application.other_income("45")
application.other_outstanding_chit("7")
application.other_outstanding_emi("4")
application.other_outstanding_insurance("7")
application.outstanding_1("1")
application.outstanding_2("1")
application.outstanding_3("4")
application.outstanding_4("5")
application.pan_card("BTRPP2391C")
application.primary_income("12")
application.secondary_income("1")
application.status("")
application.tag("")
application.tertiary_income("4")
application.timeline("1")
application.total_existing_outstanding_from("1")
application.total_existing_outstanding_from_mfi("1")
application.total_expenditure("45")
application.total_income("14")
application.total_liability("12")
application.travel_expense("45")
application.upload_type("simple")
application.vid_card("bvcbb")
application.total_running_loans("5")
application.total_other_outstanding("4")
application.total_outstanding("56")
application.save()
