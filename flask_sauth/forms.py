...
class RegistrationForm(Form):
    ...
    def validate_email( form, field):
        ...
        if User.objects(email=email).count(): raise ValidationError("Email already registered. Forget your password?")
...
class NewPasswordForm(Form):
    ...
    def validate_password2(self, field):
        ...
        if password1 != password2: raise ValidationError("The passwords don't match.")
...
class ChangePasswordForm(Form):
    ...
    def validate_password(self, field):
        ...
        if not user_cache: raise ValidationError("The current password that you entered is wrong.")
