...
class AddApplicationManual(Form):
    ...
    member_fullname=TextField( validators=[v.DataRequired(), v.Length(max=22)])
    ...
    radio_member_disability=TextField( validators=[ v.Length(max=20)])
    ...
    member_address_proof=TextField( validators=[v.DataRequired(), v.Length(max=22)])
    ...
    guarantor_fullname=TextField( validators=[v.DataRequired(), v.Length(max=30)])
    ...
    select_p_business=TextField( validators=[ v.Length(max=20)])
    ...
    product_id=TextField( validators=[v.DataRequired(), v.Length(max=22)])
