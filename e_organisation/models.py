...
class EsthenosOrgApplication(db.Document):
    ...
    branch_name = db.StringField(max_length=512, required=False,default="")
    branch_id = db.StringField(max_length=512, required=False,default="")
    ...
    micropension_inclusion=db.StringField(max_length=512, required=False,default="")
    self_owned_land=db.StringField(max_length=512, required=False,default="")
    center_leader_cell=db.StringField(max_length=512, required=False,default="")
    center_size=db.IntField(default=0)
    applicationtype=db.StringField(max_length=512, required=False,default="")
    shared_land=db.StringField(max_length=512, required=False,default="")
    ...
    bank_account_holder_name=db.StringField(max_length=20, required=False,default="")
    bank_account_number=db.StringField(max_length=20, required=False,default="")
    ...
    orchard_acre=db.IntField(default=0)
    ...
    leader_cell=db.StringField(max_length=512, required=False,default="")
