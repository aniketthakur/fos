...
class AddApplicationMobile(Form):
    ...
    applicant_business_docs_info_doc = TextField(validators=[v.Length(max=10000)])
    ...
    applicant_loan_details_active_details1 = TextField(validators=[v.Length(max=10000)])
    applicant_loan_details_active_details2 = TextField(validators=[v.Length(max=10000)])
    applicant_loan_details_active_details3 = TextField(validators=[v.Length(max=10000)])
    ...
    applicant_other_card_product = TextField(validators=[v.Length(max=10000)])
    ...
    def save(self,app):
        ...
        if not is_app:
            ...
            data = self.load(self.applicant_loan_details_active_details2)
            app.loan_details2 = self.load_loan_details(data)

            data = self.load(self.applicant_loan_details_active_details3)
            app.loan_details3 = self.load_loan_details(data)

            data = self.load(self.applicant_loan_details_active_details4)
            ...
            data = self.load(self.applicant_other_card_type_of_equipment1)
            app.type_equipment1 = self.load_type_equipment(data)

            data = self.load(self.applicant_other_card_type_of_equipment2)
            app.type_equipment2 = self.load_type_equipment(data)

            data = self.load(self.applicant_other_card_type_of_equipment3)
        ...
        # app.nominee_relation = data.get("nominee_relation", "")
            ...
            app.total_annual_revenue_credit = toInt(data.get("total_monthly_revenue__credit", ""))
            ...
            app.total_annual_revenue_cash = toInt(data.get("total_monthly_revenue__cash", ""))
            ...
            app.raw_material_purchase_in_5_month = data.get("raw_material_purchase_in_5_month", "")
            app.raw_material_purchase_in_7_month = data.get("raw_material_purchase_in_7_month", "")
            app.raw_material_purchase_in_4_month = data.get("raw_material_purchase_in_4_month", "")
            app.raw_material_purchase_in_3_month = data.get("raw_material_purchase_in_3_month", "")
            app.raw_material_purchase_in_8_month = data.get("raw_material_purchase_in_8_month", "")
            app.raw_material_purchase_in_10_month = data.get("raw_material_purchase_in_10_month", "")
            app.total_annual_purchase_cash = toInt(data.get("total_monthly_purchase__cash", ""))
            app.raw_material_purchase_in_11_month = data.get("raw_material_purchase_in_11_month", "")
            app.total_annual_purchase_credit = toInt(data.get("total_monthly_purchase__credit", ""))
            app.raw_material_purchase_in_2_month = data.get("raw_material_purchase_in_2_month", "")
            app.raw_material_purchase_in_12_month = data.get("raw_material_purchase_in_12_month", "")
            app.raw_material_purchase_in_9_month = data.get("raw_material_purchase_in_9_month", "")
            app.raw_material_purchase_in_1_month = data.get("raw_material_purchase_in_1_month", "")
            app.raw_material_purchase_in_6_month = data.get("raw_material_purchase_in_6_month", "")
