...
class EsthenosOrgApplication(db.Document):
    ...
    postal_telephone = db.StringField(max_length=128, required=False,default="")
    postal_tele_code = db.StringField(max_length=128, required=False,default="")
    postal_country = db.StringField(max_length=128, required=False,default="")
    postal_state = db.StringField(max_length=128, required=False,default="")
    postal_city = db.StringField(max_length=128, required=False,default="")
    postal_taluk = db.StringField(max_length=128, required=False,default="")
    postal_village = db.StringField(max_length=128, required=False,default="")
    member_relationship_status = db.StringField(max_length=20, required=False,default="")
    telephone_number = db.StringField(max_length=20, required=False,default="")
    mobile_number = db.StringField(max_length=20, required=False,default="")
    ...
    drinking_water = db.StringField(max_length=20, required=False,default="")
    ...
    branch_name = db.StringField(max_length=20, required=False,default="")
    branch_id = db.StringField(max_length=20, required=False,default="")
    state_name = db.StringField(max_length=20, required=False,default="")
    state_id = db.StringField(max_length=20, required=False,default="")
    region_name = db.StringField(max_length=20, required=False,default="")
    region_id  = db.StringField(max_length=20, required=False,default="")
    cm_id  = db.StringField(max_length=20, required=False,default="")
    cm_cell_no  = db.StringField(max_length=20, required=False,default="")
    repeat_application_id   = db.StringField(max_length=20, required=False,default="")
    repayment_method  = db.StringField(max_length=20, required=False,default="")
